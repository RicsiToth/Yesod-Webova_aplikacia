...
var $author$project$SampleData$timeSeries = _List_fromArray(
	[
		_Utils_Tuple2(
		$elm$time$Time$millisToPosix(1448928000000),
		2.5),
		_Utils_Tuple2(
		$elm$time$Time$millisToPosix(1451606400000),
		2),
		_Utils_Tuple2(
		$elm$time$Time$millisToPosix(1452211200000),
		3.5),
		_Utils_Tuple2(
		$elm$time$Time$millisToPosix(1452816000000),
		2),
		_Utils_Tuple2(
		$elm$time$Time$millisToPosix(1453420800000),
		3),
		_Utils_Tuple2(
		$elm$time$Time$millisToPosix(1454284800000),
		1),
		_Utils_Tuple2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$xAxis(model)
					])),
				A2(
				$elm_community$typed_svg$TypedSvg$g,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$area(model),
						_List_fromArray(
							[
						...
						A2(
						$folkertdev$one_true_path_experiment$Path$element,
						$author$project$Main$line(model),
						_List_fromArray(
							[
...
var $author$project$Main$main = $author$project$Main$view($author$project$SampleData$timeSeries);
